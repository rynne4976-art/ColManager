...
public class ClassroomService {
	...
	// 성적 등록
	public void serviceGradeInsert(String course_id_, String student_id, String total, String midtest_score,
			String finaltest_score, String assignment_score) {
	...
	// 성적 수정
	public void serviceGradeUpdate(String course_id_, String student_id, String total, String midtest_score,
			String finaltest_score, String assignment_score) {
...
//	}
	...
	public ArrayList<AttendanceVo> serviceAttendanceByStudent(String studentId) {
		return classroomdao.getAttendanceByStudent(studentId);
	}

	public ArrayList<AttendanceVo> serviceAttendanceByCourseAndDate(String courseId, Date classDate) {
		return classroomdao.getAttendanceByCourseAndDate(courseId, classDate);
	}

	public ArrayList<StudentVo> serviceStudentSearch(String course_id_, String studentNameKeyword) {
		return classroomdao.studentSearch(course_id_, studentNameKeyword);
	}

	public int serviceInsertAttendance(AttendanceVo vo) {
		boolean enrolled = classroomdao.isEnrolledStudent(vo.getStudent_id(), vo.getCourse_id());

		if (!enrolled) {
			return -1;
		}

		boolean exists = classroomdao.existsAttendance(vo.getStudent_id(), vo.getCourse_id(), vo.getClass_date());

		if (exists) {
			return -2;
		}

		return classroomdao.insertAttendance(vo);
	}

	public int serviceUpdateAttendance(AttendanceVo vo) {
		boolean exists = classroomdao.existsAttendance(vo.getStudent_id(), vo.getCourse_id(), vo.getClass_date());
