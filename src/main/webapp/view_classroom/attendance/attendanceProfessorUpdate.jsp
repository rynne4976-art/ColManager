...
<div class="attendance-page-wrap">
    <h2 class="section-page-title">출석 수정 관리</h2>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/classroom/attendanceUpdate.do" method="get">
                ...
                <div class="row mt-3">
                    <div class="col-md-2">
                        <a class="btn btn-success w-100"
                           href="${pageContext.request.contextPath}/classroom/attendanceProfessor.do?course_id=${selectedCourseId}&class_date=${classDate}&student_name=${studentNameKeyword}&attendance_status=${attendanceStatusFilter}">
                            출결 등록
                        </a>
                    </div>
                    ...
                    <div class="col-md-8 d-flex justify-content-end">
                        <a href="${pageContext.request.contextPath}/classroom/attendanceUpdate.do"
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="attendanceUpdateForm"
                      action="${pageContext.request.contextPath}/classroom/attendanceUpdate.do"
                      method="post">
                        ...
                        <table class="table table-bordered table-hover align-middle text-center">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th style="width: 18%;">현재 출석상태</th>
                                    <th>비고</th>
                                    <th style="width: 12%;">개별수정</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-3">
                        <button type="button"
                                ...
                                onclick="submitSelectedUpdate(this)">
                            선택 학생 수정
                        </button>
                    </div>
                </form>
    ...
    <c:if test="${empty studentList && not empty selectedCourseId}">
        <div class="alert alert-warning">
            조회 조건에 맞는 등록된 출결이 없습니다.
        </div>
    </c:if>
</div>

<script>
let isSubmittingAttendanceUpdate = false;

function getAttendanceUpdateForm() {
    return document.getElementById("attendanceUpdateForm");
}
...
function toggleAllStudents(source) {
    if (isSubmittingAttendanceUpdate) {
        return;
    }
...
function submitSelectedUpdate(button) {
    if (isSubmittingAttendanceUpdate) {
        return;
    }
    ...
    isSubmittingAttendanceUpdate = true;
    disableActionButtons(button, "수정 중...");

    document.getElementById("updateMode").value = "selected";
    document.getElementById("singleStudentId").value = "";
    getAttendanceUpdateForm().submit();
}

function submitSingleUpdate(studentId, button) {
    if (isSubmittingAttendanceUpdate) {
        return;
    }
    ...
    document.getElementById("updateMode").value = "single";
