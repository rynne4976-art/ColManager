...
<body class="sb-nav-fixed">
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		...
		<a class="navbar-brand ps-3"
			href="<%=contextPath%>/classroom/classroom.bo?classroomCenter=professorMyCourse.jsp">강의실</a>
		<%
		} else {
		%>
		<a class="navbar-brand ps-3"
			href="<%=contextPath%>/classroom/allAssignNotice.do">강의실</a>
		<%
		}
		%>
		...
		<ul class="navbar-nav ms-auto d-flex align-items-center">
			...
			<li class="nav-item">
				...
				<button class="btn btn-light me-2"
					onclick="location.href='<%=contextPath%>/member/main.bo'">
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link"
									href="<%=contextPath%>/classroom/course_register.bo">수강 등록</a>
								<a class="nav-link"
									href="<%=contextPath%>/classroom/course_search.bo?center=/view_classroom/courseSearch.jsp">수강
									조회(수정/삭제)</a>
							</nav>
						</div>
						...
						<a class="nav-link"
							href="<%=contextPath%>/classroom/attendanceProfessor.do">
							<div class="sb-nav-link-icon">
						...
						<a class="nav-link"
							href="<%=contextPath%>/classroom/course_search.bo?center=/view_classroom/courseList.jsp">
							<div class="sb-nav-link-icon">
						...
						<!-- 사이드바 강의 평가 영역 -->
						<a class="nav-link"
							href="<%=contextPath%>/professor/evaluationList.bo">
							<div class="sb-nav-link-icon">
						...
						<div class="sb-sidenav-menu-heading">ATTENDANCE</div>
						<a class="nav-link"
							href="<%=contextPath%>/classroom/attendanceStudent.do">
							<div class="sb-nav-link-icon">
						...
						<div class="sb-sidenav-menu-heading">SCORE</div>
						<a class="nav-link"
							href="<%=contextPath%>/classroom/grade_search.bo?classroomCenter=/view_classroom/gradeList.jsp">
							<div class="sb-nav-link-icon">
								<i class="fas fa-chart-area"></i>
							</div> 성적 조회
						</a>
						...
						<!-- 강의 평가 항목 추가 -->
						<a class="nav-link"
							href="<%=contextPath%>/student/evaluationRegister.do">
							<div class="sb-nav-link-icon">
								<i class="fas fa-star"></i>
							</div> 강의 평가
						</a>
						...
						<!-- 증명서 조회 -->
						<div class="sb-sidenav-menu-heading">CERTIFICATE</div>
						<a class="nav-link"
							href="<%=contextPath%>/classroom/certificate.bo">
							<div class="sb-nav-link-icon">
